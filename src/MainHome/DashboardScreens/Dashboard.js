...
const Dashboard = () => {
  ...
  const { isLoaded } = useLoadScript({
    googleMapsApiKey:'AIzaSyAGucoMHNFROxZFeUurLhxpSHNq-tpCUpo',
  });
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          async (position) => {
            ...
            const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.coords.latitude},${position.coords.longitude}&key=AIzaSyAGucoMHNFROxZFeUurLhxpSHNq-tpCUpo`);
...
console.log('Destination:', destination);
  ...
  const geocodeAddress = async (address) => {
    const apiKey = 'AIzaSyAGucoMHNFROxZFeUurLhxpSHNq-tpCUpo'; // Replace with your actual API key
  ...
  return (
    <div className="dashboard">
      ...
      <div className="top-section">
        ...
        <div className="menu">
          <ul className="menuUL">
            <li className="menuList"><Link to="/user/home">Home</Link></li>
            <li className="menuList"><Link to="/user/trips">YourTrips</Link></li>
            <li className="menuList"><Link to="/user/payments">Payments</Link></li>
            <li className="menuList"><Link to="/user/aboutUS">About Us</Link></li>
            <li className="menuList"><Link to="/user/settings">Settings</Link></li>
            <li className="menuList"><Link to="/user/help">Help</Link></li>
          </ul>
        </div>
        ...
        {isDropdownOpen && (
          <div className="profile-dropdown" ref={dropdownRef}>
            <ul>
              <li><Link to="/user/editprofile">Profile</Link></li>
...
{userLocation ? (
        <GoogleMapReact
          bootstrapURLKeys={{ key: 'AIzaSyAGucoMHNFROxZFeUurLhxpSHNq-tpCUpo' }}
          defaultCenter={{
...
{distance && duration && (
        <div className="distancebox">
          <p className="distance"><b>Distance:</b> <span className="distance-data">{distance} miles</span></p>
          <p className="duration"><b>Duration:</b> <span className="duration-data">{duration} mns</span></p>
        </div>
      )}
        ...
        (
          <div className="form-container">
          <h3>Select your preferred car option</h3>
          <div>
